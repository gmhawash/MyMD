...
int row,i,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,reservedcounter, qbit,power, numPermInFile,ccvv,bq,best,ccdds;
FILE *in; 
...
ifstream issss("myperm12.txt");


ofstream file;   
if (qbit==6)
{ifstream issss("myperm6.txt");}
else if (qbit==9)
{ifstream issss("myperm9.txt");}
else if (qbit =12)
{ifstream issss("myperm12.txt");}

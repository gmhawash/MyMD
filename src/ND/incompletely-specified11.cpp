  ...
  using namespace std;
int array[1048576][20], order[1048576], outarray[1048576][20], temparray[1048576][20], possibilities[1048576][32],DontCareLocation[1048576][20],DontCarePerRow[1048576],dontcareaddress[1048576][20],pwr[20], value[1048576],NumPossibilities[1048576],reserved[1048576],perm[1048576][25];
int row,i,i1,i2,i3,i4,i5,i6,i7,i8,i9,reservedcounter, qbit,power, numPermInFile,ccvv,bq;
FILE *in; 
...
//            for ( i1 = 0; i1 < power ;++ i1 )cout << "NumPossibilities["<<i1<<"] "<<NumPossibilities[i1]<<"\n";
            ...
            */
            ...
            for ( i1 = 0; i1 < power ;++ i1 )
                ...
                bq=0;     
                ccvv=999999999;     
                if (NumPossibilities[i1]!=1){for ( i2 = 0; i2< NumPossibilities[i1] ;++ i2 )if (abs (possibilities[i1][i2]-perm[i1][0])< ccvv){possibilities[i1][0]=possibilities[i1][i2];bq=1;NumPossibilities[i1]=1;}}
                if (bq==1){break;}
                }
}
